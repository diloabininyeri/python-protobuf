...
from bidirectional import bi_directional_pb2 as bi__directional__pb2
...
class BidirectionalStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetServerResponse = channel.stream_stream(
                ...
                request_serializer=bi__directional__pb2.Message.SerializeToString,
                response_deserializer=bi__directional__pb2.Message.FromString,
                )
...
def add_BidirectionalServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetServerResponse': grpc.stream_stream_rpc_method_handler(
                    ...
                    request_deserializer=bi__directional__pb2.Message.FromString,
                    response_serializer=bi__directional__pb2.Message.SerializeToString,
            ),
    }
...
class Bidirectional(object):
    ...
    def GetServerResponse(request_iterator,
        ...
        return grpc.experimental.stream_stream(request_iterator, target, '/bidirectional.Bidirectional/GetServerResponse',
            bi__directional__pb2.Message.SerializeToString,
            bi__directional__pb2.Message.FromString,
